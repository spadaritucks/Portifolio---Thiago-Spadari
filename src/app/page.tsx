    ...
    <MainLayout>
      ...
      <section className="project-section" id="project-section">
        ...
        <ProjectCard projectImage={portifolioImage} technologies={[{ src: typescriptIcon }, { src: nextJsIcon }]} title="Portifolio - Thiago Spadari"
          ...
          { src: laravelIcon }]} title="Site + Sistema de Administração" company=" Empresarial - ACADEMIAS IMOOGI" description=" Responsável por criar e realizar a manutenção do site/sistema de administração da empresa em ambas as vertentes,
